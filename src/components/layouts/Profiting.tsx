...
export default function Profiting() {
  return (
    <section className="mt-[120px] px-[190px]">
      ...
      <div className="flex gap-[71px] mb-[141px] relative">
        <Image
          ...
          priority
        />
        <div className="absolute w-[947px] h-[485px] rounded-md inset-0">
          <div className="absolute inset-0 rounded-md bg-hero-pattern mix-blend-soft-light"></div>
        </div>
