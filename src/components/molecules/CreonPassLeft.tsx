...
export default function CreonPassLeft() {
  ...
  return (
    <>
      ...
      <>
        <aside className="flex flex-col w-1/2 my-[113px] mr-[10px] xl:hidden">
          ...
          <p className="bg-linear bg-clip-text text-transparent font-bold font-satoshi text-lg leading-[130%] mb-[30px]">
          ...
          <button className="w-[50%] flex justify-end items-start rounded-md bg-linear text-white font-satoshi text-base font-bold pl-[58px] pr-[56px] pt-3 mt-[30px] pb-[22px] flex-shrink-0">
            Buy Creon Pass
          </button>
        </aside>
      </>
